<?php
$pageTitle = "Casual Wear Collection";
...
?>
    ...
    <section class="page-header-section">
        <div class="container">
            <h1 class="page-header-title">CASUAL WEAR</h1>
            <p class="page-header-subtitle">Discover comfort meets style in our casual collection</p>
        </div>
    </section>
            ...
            <div class="products-grid">
                <?php if (count($products) > 0): ?>
                    ...
                    <div class="product-card">
                        ...
                        <a href="product-details.php?id=<?php echo $product['id']; ?>&from=casual" class="product-link">
                ...
                <?php else: ?>
                    <div class="search-empty">
                        <h2>No Casual Wear Products Found</h2>
                        <p>We're currently updating our casual wear collection. Check back soon!</p>
                    </div>
                <?php endif; ?>
            </div>
        </div>
