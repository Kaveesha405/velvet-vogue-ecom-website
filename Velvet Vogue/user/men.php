...
$formalProducts = getProductsByMultipleCategories(['Men', 'Formal Wear']);
$casualProducts = getProductsByMultipleCategories(['Men', 'Casual Wear']);
$accessoriesProducts = getProductsByMultipleCategories(['Men', 'Accessories']);
$footwearProducts = getProductsByMultipleCategories(['Men', 'Footwear']);
...
<section class="page-header-section">
    <div class="container">
        <h1 class="page-header-title">MEN'S COLLECTION</h1>
        <p class="page-header-subtitle">Elevate your wardrobe with our premium men's fashion</p>
    </div>
</section>
    ...
    <div class="container">
        ...
        <div class="products-fade" id="formal-products-container">
            <div class="products-grid">
                ...
                ?>
                <a href="product-details.php?id=<?php echo $product['id']; ?>&from=men" 
